...
class InputTextProviderCustom extends StatelessWidget {
  bool? obscureText;
  ...
  InputTextProviderCustom({super.key,this.obscureText, required this.controller, required this.hintText , this.textInputType,this.validator,
